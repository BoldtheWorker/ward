...
const imagePath = 'C:/Users/Barbara Awuitor/.gemini/antigravity/brain/7610f9bd-801d-421e-9848-ea781f42c46a/africa_real_estate_insight_v1_png_1775211768913.png';
const fileName = `africa-real-estate-${Date.now()}.png`;
...
async function run() {
  try {
    ...
    console.log('Success! Article inserted:', insertData[0].id);
  } catch (err) {
